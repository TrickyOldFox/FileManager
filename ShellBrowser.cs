    ...
    public partial class ShellBrowser : System.Windows.Forms.UserControl
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listBox1.SelectedItem != null)
            {
                ...
                {
                    context = new State.DecisionMaker(new State.FolderChosen());
                }
                else
                {
                    context = new State.DecisionMaker(new State.FileChosen());
                }
            }
            else
            {
                context = new State.DecisionMaker(new State.NotReady());
            }
